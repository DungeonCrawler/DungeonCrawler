...
public class Key {
	...
	private int exModifiers;
	
	Key(int keyCode, char character, int exModifiers) {
		this.keyCode = keyCode;
		this.character = character;
		this.exModifiers = exModifiers;
	}
	...
	public boolean isShiftPressed() {
		return (KeyEvent.SHIFT_DOWN_MASK & exModifiers) > 0;
	}

	public boolean isCtrlPressed() {
		return (KeyEvent.CTRL_DOWN_MASK & exModifiers) > 0;
	}

	public boolean isAltPressed() {
		return (KeyEvent.ALT_DOWN_MASK & exModifiers) > 0;
	}
	...
	public String getModifierString() {
		return KeyEvent.getModifiersExText(exModifiers);
	}
	
	@Override
	public String toString() {
		String mod = getModifierString();
		if (mod.isEmpty())
			return getKeyString();
		else
			return mod + " + " + getKeyString();
	}
    ...
    public final static int keypadUp = KeyEvent.VK_KP_UP;
    public final static int keypadDown = KeyEvent.VK_KP_DOWN;
    public final static int keypadLeft = KeyEvent.VK_KP_LEFT;
    public final static int keypadRight = KeyEvent.VK_KP_RIGHT;
	...
	public final static int numpad0 = KeyEvent.VK_NUMPAD0;
	...
	public final static int main0 = KeyEvent.VK_0;
	public final static int main1 = KeyEvent.VK_1;
	public final static int main2 = KeyEvent.VK_2;
	public final static int main3 = KeyEvent.VK_3;
	public final static int main4 = KeyEvent.VK_4;
	public final static int main5 = KeyEvent.VK_5;
	public final static int main6 = KeyEvent.VK_6;
	public final static int main7 = KeyEvent.VK_7;
	public final static int main8 = KeyEvent.VK_8;
	public final static int main9 = KeyEvent.VK_9;
	
	public final static int home = KeyEvent.VK_HOME;
	public final static int end = KeyEvent.VK_END;
	public final static int pageUp = KeyEvent.VK_PAGE_UP;
	public final static int pageDown = KeyEvent.VK_PAGE_DOWN;
	public final static int begin = KeyEvent.VK_BEGIN;
	...
	public final static int multiply = KeyEvent.VK_MULTIPLY;
	public final static int divide = KeyEvent.VK_DIVIDE;
	
	public final static int escape = KeyEvent.VK_ESCAPE;
	public final static int enter = KeyEvent.VK_ENTER;
	
	public final static int less = KeyEvent.VK_LESS;
	public final static int greater = KeyEvent.VK_GREATER;
